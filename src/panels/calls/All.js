...
import { Panel, PanelHeader, Group, Div, Button, Header, PanelHeaderBack } from '@vkontakte/vkui';
...
const All = props => (
    <Panel id={props.id}>
        <PanelHeader left={<PanelHeaderBack onClick={props.go} data-to="calc" />}>Всего</PanelHeader>
			<div className="App" >
				<Div><Table1 data={all}/></Div>
			</div>
    </Panel>
